...
To reuse longer sections or text with more advanced markup, you can put the content in a separate file and include this file in several locations.
...
* - Input
  - Output
* - ````
    % Include content from file [reuse/include_test.md](reuse/include_test.md)
    ```{include} reuse/include_test.md
    ```
    ````
